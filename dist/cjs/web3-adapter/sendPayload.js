...
function makePayloadSender(alchemySend, config) {
    var currentWriteProvider = getEip1193Provider(config.writeProvider);
...
function getEip1193Provider(provider) {
    if (!provider) {
        return undefined;
    }
    ...
    return {
        send: function (method, params) {
            return promises_1.promisify(function (callback) {
                return sendMethod({ jsonrpc: "2.0", id: "legacy:" + nextId++, method: method, params: params }, callback);
            });
        },
    };
}
